            ...
            <div className="inline-block overflow-hidden relative z-20 p-6 my-8 w-full max-w-md text-left align-middle bg-white rounded-2xl shadow-xl transition-all">
              ...
              <div className="flex justify-center mt-4">
                <button
                  ...
                  type="button"
                  className="focus:z-10 py-2 px-5 mr-2 text-sm font-medium text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white bg-white hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-500 focus:ring-4 focus:ring-gray-300"
                >
                  キャンセル
                </button>
                <button
                  ...
                  type="button"
                  className="inline-flex items-center py-2.5 px-7 text-sm font-medium text-center text-white bg-red-600 hover:bg-red-800 rounded-lg focus:ring-4 focus:ring-red-300"
                >
                  削除する
                </button>
              </div>
